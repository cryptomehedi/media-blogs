    ...
    return (
        <section className="text-gray-600 body-font">
            <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
                ...
                <form onSubmit={e => e.preventDefault()} className="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
                    ...
                    <p className='my-3 cursor-pointer'>forget password ?</p>
                    ...
                    <p className="text-xs text-red-400 mt-3"></p>
                </form>
            </div>
        </section>
    );
